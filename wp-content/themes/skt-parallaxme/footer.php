...
<footer class="footer cf">
    <div class="container">
        ...
        <div class="columns three footer-logo">
            ...
            <?php } ?>
           <?php esc_html_e('Theme By ','skt-parallaxme');?><a href="<?php echo esc_url('https://www.sktthemes.org/');?>" rel="nofollow" target="_blank"><?php esc_html_e('SKT Themes','skt-parallaxme'); ?></a>
        </div>
        <!-- ./five -->

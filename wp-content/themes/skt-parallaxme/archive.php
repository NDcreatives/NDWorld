                ...
                <header class="page-header">
                    <h1 class="page-title">
                       <?php
						...
						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'skt-parallaxme' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'skt-parallaxme' ) ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Year: %s', 'skt-parallaxme' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'skt-parallaxme' ) ) . '</span>' );

...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Parallax Me Theme Options', 'skt-parallaxme'),
		'menu_title' => __('Theme Options', 'skt-parallaxme'),
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear','skt-parallaxme' ),
			'defaultString' => __( 'Default', 'skt-parallaxme' ),
			'pick' => __( 'Select Color', 'skt-parallaxme' )
		);
...
function of_admin_head() {
	...
	do_action( 'skt_parallaxme_optionsframework_custom_scripts' );
}
...
function optionsframework_page() {
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
		<div style="padding-bottom:10px;"><a href="<?php echo 'https://www.sktthemes.org/shop/skt_parallax_me_pro/';?>" target="_blank">Buy PRO version for only $39 with more features.</a></div>
	    ...
	    <div id="optionsframework" class="postbox" style="width:72%; float:left;" >
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'skt-parallaxme' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'skt-parallaxme' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'skt-parallaxme' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
        ...
        <div style="width:25%; float:right;" class="postbox-container side">
            <div class="meta-box-sortables ui-sortable">
                <div class="postbox">
                    ...
                    <div class="inside">
						<p><a target="_blank" href="https://www.sktthemes.org/themes"><img style="max-width:100%" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/sktskill.jpg"></a></p>
                    </div>
                </div>
                <div class="postbox">
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'skt-parallaxme' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'skt-parallaxme' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'SKT Parallax Me Settings', 'skt-parallaxme' ),
			'href' => admin_url( 'themes.php?page=skt_parallaxme-options' )
		));
}

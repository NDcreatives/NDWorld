 ...
 *
 * @uses skt_parallaxme_header_style()
 * @uses skt_parallaxme_admin_header_style()
 * @uses skt_parallaxme_admin_header_image()
...
function skt_parallaxme_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'skt_parallaxme_custom_header_args', array(
		...
		'admin-head-callback'    => 'skt_parallaxme_admin_header_style',
		'admin-preview-callback' => 'skt_parallaxme_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'skt_parallaxme_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see skt_parallaxme_custom_header_setup().
 */
function skt_parallaxme_admin_header_style() {?>
	<style type="text/css">
	.appearance_page_custom-header #headimg { border: none; }
	</style><?php
}
endif; // skt_parallaxme_admin_header_style
...
if ( ! function_exists( 'skt_parallaxme_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see skt_parallaxme_custom_header_setup().
 */
function skt_parallaxme_admin_header_image() {
...
endif; // skt_parallaxme_admin_header_image 
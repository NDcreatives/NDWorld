...
printf( esc_html__( 'Theme: %1$s By %2$s.', 'businessdeal' ), __('BusinessDeal <span class="sep"> | </span> ','businessdeal'),'<a href="'.esc_url('https://themefreesia.com/') .'">' . esc_html__('Theme Freesia','businessdeal').'</a>' );
}

...
if ( ! function_exists( 'businessdeal_posted_on' ) ) :
	...
	function businessdeal_posted_on() {
		$time_string = '<time class="entry-date published updated" datetime="%1$s"><i class="fa-regular fa-calendar-days"></i> %2$s </time>';
		if ( get_the_time( 'U' ) !== get_the_modified_time( 'U' ) ) {
			$time_string = '<time class="entry-date published" datetime="%1$s"><i class="fa-regular fa-calendar-days"></i>%2$s</time>';
		}

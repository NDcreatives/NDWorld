...
<p>Phasellus fermentum augue vulputate, pulvinar odio in, semper risus. Donec rhoncus dolor in tortor venenatis, ac pharetra mauris venenatis. Aliquam</p>
	...
	$options[] = array(
		...
		'id' => 'footertext',
		'std' => '&copy; 2023. Design by <a target="_blank" href="'.esc_url('https://sktthemes.org').'">SKT Themes</a>',
		'type' => 'textarea');
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'desc' => '<a href="'.esc_url(SKT_THEME_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url('https://sktthemes.org/shop/skt_parallax_me_pro/').'">Buy PRO version for only $39 with more features.</a></em></p>',
		'type' => 'info');	

...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-parallaxme' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-parallaxme' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-parallaxme' ),
		'repeat'    => __( 'Repeat All', 'skt-parallaxme' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-parallaxme' ),
		'top center'    => __( 'Top Center', 'skt-parallaxme' ),
		'top right'     => __( 'Top Right', 'skt-parallaxme' ),
		'center left'   => __( 'Middle Left', 'skt-parallaxme' ),
		'center center' => __( 'Middle Center', 'skt-parallaxme' ),
		'center right'  => __( 'Middle Right', 'skt-parallaxme' ),
		'bottom left'   => __( 'Bottom Left', 'skt-parallaxme' ),
		'bottom center' => __( 'Bottom Center', 'skt-parallaxme' ),
		'bottom right'  => __( 'Bottom Right', 'skt-parallaxme')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-parallaxme' ),
		'fixed'  => __( 'Fixed in Place', 'skt-parallaxme')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-parallaxme' ),
		'italic'      => __( 'Italic', 'skt-parallaxme' ),
		'bold'        => __( 'Bold', 'skt-parallaxme' ),
		'bold italic' => __( 'Bold Italic', 'skt-parallaxme' )
	);
